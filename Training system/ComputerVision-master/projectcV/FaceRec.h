...
void eigenFaceTrainer(){
	...
	model->save("D:/FDB/yaml/eigenface.yml");
...
void fisherFaceTrainer(){
	...
	model->save("D:/FDB/yaml/fisherface.yml");
...
void LBPHFaceTrainer(){
	...
	model->save("D:/FDB/yaml/LBPHface.yml");
...
int  FaceRecognition(){
	...
	Ptr<FaceRecognizer>  model = createFisherFaceRecognizer();
	model->load("D:/FDB/yaml/fisherface.yml");

	Mat testSample = imread("D:/db/s41/5.pgm", 0);
